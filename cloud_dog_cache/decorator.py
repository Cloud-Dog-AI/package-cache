    ...
    *,
    ...
    def decorator(fn: Callable) -> Callable:
        ...
        async def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            # Extract hash params
            ctx_hash = str(params.pop(context_hash_param, "")) if context_hash_param else ""
            model_hash = str(params.pop(model_config_hash_param, "")) if model_config_hash_param else ""
